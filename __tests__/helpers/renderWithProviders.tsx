...
export const renderWithNavigation = (ui: React.ReactElement, options?: RenderOptions) => {
  const AllTheProviders: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    return (
      <SafeAreaProvider>
...
export const renderWithAllProviders = (ui: React.ReactElement, options?: RenderOptions) => {
  const queryClient = new QueryClient({
    defaultOptions: {
      queries: {
        retry: false,
...
export const renderWithAccessibility = (ui: React.ReactElement, options?: RenderOptions) => {
  const AllTheProviders: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    return (
      <SafeAreaProvider>
        <MockStoreProvider>
