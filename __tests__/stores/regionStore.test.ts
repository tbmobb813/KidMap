...
describe('Region Store', () => {
  ...
  describe('Region Management', () => {
    ...
    it('should find region by coordinates', () => {
      const { setAvailableRegions, findRegionByCoordinates } = useRegionStore.getState();
  ...
  describe('Transit System Management', () => {
    ...
    it('should get transit systems for region', () => {
      ...
      const mtaSubway = regionTransitSystems?.find(ts => ts.name === 'MTA Subway');
  ...
  describe('Data Integration', () => {
    ...
    it('should verify transit system associations', () => {
      const mtaSubway = mockTransitSystems.find(ts => ts.name === 'MTA Subway');
