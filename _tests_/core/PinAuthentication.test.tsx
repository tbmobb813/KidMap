...
describe("PinAuthentication", () => {
  ...
  describe("Basic Rendering", () => {
    it("renders without crashing", () => {
      const { getByText } = render(<PinAuthentication {...defaultProps} />, {
    ...
    it("displays default title and subtitle", () => {
      ...
      expect(getByText("Parent Mode")).toBeTruthy();
      expect(
        getByText("Enter your PIN to access parental controls")
      ).toBeTruthy();
    });
    ...
    it("displays lock icon", () => {
      const { getByTestId } = render(<PinAuthentication {...defaultProps} />, {
        wrapper: createTestWrapper(),
      });
  ...
  describe("PIN Setting Flow", () => {
    ...
    it("shows PIN setting title and subtitle", () => {
      const { getByText } = render(<PinAuthentication {...settingProps} />, {
        wrapper: createTestWrapper(),
      });
