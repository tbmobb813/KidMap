...
// Test data factory
const createTestSafeZone = (
  id: string,
  overrides: Partial<SafeZone> = {},
): SafeZone =>
  createMockSafeZone({
    id,
    name: `Test Zone ${id}`,
...
describe('SafeZoneAlertManager', () => {
  ...
  describe('Initialization', () => {
    it(
      'should initialize successfully with default settings',
      async () => {
    ...
    it(
      'should load saved settings from AsyncStorage',
      async () => {
        const savedSettings = {
    ...
    it(
      'should handle malformed AsyncStorage data',
      async () => {
  ...
  describe('Event Handling', () => {
    ...
    it(
      'should handle valid safe zone events',
      async () => {
    ...
    it(
      'should update gamification system',
      async () => {
        const gamificationStore =
          require('@/stores/gamificationStore').useGamificationStore.getState()
  ...
  describe('Settings Management', () => {
    ...
    it(
      'should reject invalid cooldown values',
      async () => {
        await expect(
  ...
  describe('Event History Management', () => {
    ...
    it(
      'should limit event history to maximum items',
      async () => {
  ...
  describe('Quiet Hours', () => {
    ...
    it(
      'should not send alerts during quiet hours',
      async () => {
        const { speechEngine } = require('@/utils/speechEngine')
    ...
    it(
      'should send alerts outside quiet hours',
      async () => {
        const { speechEngine } = require('@/utils/speechEngine')
  ...
  describe('Error Recovery', () => {
    ...
    it(
      'should retry AsyncStorage operations on failure',
      async () => {
    ...
    it(
      'should handle persistent storage failures gracefully',
      async () => {
