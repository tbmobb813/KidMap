...
// import { backendHealthMonitor } from './api'; // Removed due to missing export
...
class OfflineManager {
  ...
  getNetworkQuality(): "excellent" | "good" | "poor" | "offline" {
    ...
    // Without backendHealthMonitor, fallback to basic network state
    if (this.networkState.isWifiEnabled) {
      return "excellent";
